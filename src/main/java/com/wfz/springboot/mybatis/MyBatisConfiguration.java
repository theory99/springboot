package com.wfz.springboot.mybatis;
...
public class MyBatisConfiguration {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSource dataSource) {
        ...
        // 设置别名包
        //sqlSessionFactoryBean.setTypeAliasesPackage("com.wfz.domain");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.wfz.springboot.dao");
